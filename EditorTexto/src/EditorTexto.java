...
public class EditorTexto extends JFrame {
    ...
    private Action _saveServerAction = new SaveServerAction(serv);
    private Action _exitServerAction = new ExitServerAction(serv);
    ...
    public EditorTexto() {
        ...
        JMenu auxiliarMenu = menuBar.add(auxiliar.getMenu());
        JMenu serverMenu = menuBar.add(new JMenu("Servidor"));
        fileMenu.setMnemonic('E');
        fileMenu.add(_openAction);
        fileMenu.add(_saveAction);
        fileMenu.addSeparator();
        fileMenu.add(_exitAction);
        editorMenu.setMnemonic('F');
        editorMenu.add(undoAction);
        editorMenu.add(redoAction);
        auxiliarMenu.setMnemonic('G');
        serverMenu.setMnemonic('H');
        serverMenu.add(_saveServerAction);
        serverMenu.add(_exitServerAction);
    ...
    /**
     *
     * Açoes referentes a entrega 1: Abrir arquivos Essa funçao abre um arquivo
     * de texto
     *
     */
    ...
    /**
     *
     * Açoes referentes a entrega 1: Salvar o texto Essa funçao salva o texto
     * quando a acao de salvar o texto é invocada
     *
     */
    ...
    /**
     *
     * Açoes referentes a entrega 1: Sair do programa Essa funçao sai do
     * programa quando a acao de sair invocada
     *
     */
...
////////////////////////////////////////////////////////////////////////
    ...
    /**
     * Classe responsável por salvar o arquivo editado no servirdor. 
     */
    class SaveServerAction extends AbstractAction {
        Servidor serv;

        SaveServerAction(Servidor S) {
            super("Salvar na nuvem");
    ...
    /**
     * Classe responsável por encerrar a Thread da classe Prcesso que salva o arquivo no servidor. 
     */
    
        class ExitServerAction extends AbstractAction {
            Servidor serv;
            
            public ExitServerAction(Servidor S) {
                super("Desconectar");
